  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  private boolean configureTransitions(int paramInt, TransitionState paramTransitionState, boolean paramBoolean, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    if (localObject2 != null)
    {
      ...
      label146: if (localSharedElementCallback != null)
      {
    ...
    if ((this.mSharedElementTargetNames != null) && (localArrayMap1 != null))
    {
      ...
      View localView = (View)localArrayMap1.get(localObject6);
      if (localView != null)
      {
    ...
    for (boolean bool = localFragment1.getAllowReturnTransitionOverlap(); ; bool = localFragment1.getAllowEnterTransitionOverlap())
    {
      ...
      if (localObject5 == null)
        break label488;
      return true;
      label454: localArrayList1.addAll(localArrayMap1.values());
      break;
      label468: localSharedElementCallback = localFragment1.mEnterTransitionCallback;
      break label146;
    }
    label488: return false;
  }
    ...
    paramView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener()
    {
      public boolean onPreDraw()
      {
        ...
        while (true)
        {
          ...
          return true;
          label127: paramArrayList.addAll(localArrayMap.values());
        }
      }
    });
  }
  ...
  public TransitionState popFromBackStack(boolean paramBoolean, TransitionState paramTransitionState, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    if (paramTransitionState == null)
    {
      ...
      if (paramTransitionState == null)
        break label253;
      k = 0;
      label122: if (paramTransitionState == null)
        break label263;
    }
    label263: for (int m = 0; ; m = localOp.popExitAnim)
      ...
      default:
        ...
        break label85;
        label235: i = this.mTransitionStyle;
        break label97;
  ...
  public void run()
  {
    ...
    if (localTransitionState != null)
    {
      ...
      if (localTransitionState == null)
        break label242;
      m = 0;
      label139: if (localTransitionState == null)
        break label252;
    }
    label233: label242: label252: for (int n = 0; ; n = localOp.exitAnim)
      switch (localOp.cmd)
      {
      default:
        throw new IllegalArgumentException("Unknown cmd: " + localOp.cmd);
    ...
    while (true)
    {
      ...
      if (this.mManager.mAdded != null)
      {
        ...
        if (i1 < this.mManager.mAdded.size())
        {
          ...
          while (true)
          {
            ...
            this.mManager.removeFragment(localFragment7, k, j);
          }
        }
      }
      if (localFragment6 != null)
      {
        ...
        continue;
        Fragment localFragment5 = localOp.fragment;
        localFragment5.mNextAnim = n;
        this.mManager.removeFragment(localFragment5, k, j);
        continue;
        Fragment localFragment4 = localOp.fragment;
        localFragment4.mNextAnim = n;
        this.mManager.hideFragment(localFragment4, k, j);
        continue;
        Fragment localFragment3 = localOp.fragment;
        localFragment3.mNextAnim = m;
        this.mManager.showFragment(localFragment3, k, j);
        continue;
        Fragment localFragment2 = localOp.fragment;
        localFragment2.mNextAnim = n;
        this.mManager.detachFragment(localFragment2, k, j);
        continue;
        Fragment localFragment1 = localOp.fragment;
        localFragment1.mNextAnim = m;
        this.mManager.attachFragment(localFragment1, k, j);
      }
    }
    label727: this.mManager.moveToState(this.mManager.mCurState, k, j, true);
    if (this.mAddToBackStack)
