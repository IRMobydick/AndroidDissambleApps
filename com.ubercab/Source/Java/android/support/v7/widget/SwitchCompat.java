...
public class SwitchCompat extends CompoundButton
{
  ...
  private boolean hitThumb(float paramFloat1, float paramFloat2)
  {
    ...
    return (paramFloat1 > k) && (paramFloat1 < m) && (paramFloat2 > j) && (paramFloat2 < n);
  }
  ...
  private void stopDrag(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      int k = 0;
      break;
      label91: boolean bool = false;
      continue;
      label96: if (f <= 0.0F)
      {
        bool = false;
        continue;
        label108: bool = getTargetCheckedState();
        continue;
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    label230: label239: for (int i1 = localRect2.left + localRect2.right; ; i1 = getWidth())
    {
  ...
  public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo paramAccessibilityNodeInfo)
  {
    ...
    label59: for (CharSequence localCharSequence1 = this.mTextOn; ; localCharSequence1 = this.mTextOff)
    {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (true)
    {
      ...
      localRect.setEmpty();
      break;
      label152: i = 0 + (getWidth() - getPaddingRight());
  ...
  public void setSwitchTextAppearance(Context paramContext, int paramInt)
  {
    ...
    label108: for (this.mSwitchTransformationMethod = new AllCapsTransformationMethod(getContext()); ; this.mSwitchTransformationMethod = null)
    {
