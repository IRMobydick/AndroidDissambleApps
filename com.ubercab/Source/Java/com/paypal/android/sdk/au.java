  ...
  implements ap
{
  ...
  public au()
  {
    a.put(bG.a, "Authenticating");
    a.put(bG.b, "Back");
    a.put(bG.c, "Cancel");
    a.put(bG.d, "Checking this device…");
    a.put(bG.e, "Clear card information");
    a.put(bG.f, "Confirm");
    a.put(bG.g, "Are you sure you want to clear your card information?");
    a.put(bG.h, "Charge Card");
    a.put(bG.i, "Are you sure you want to log out of PayPal?");
    a.put(bG.j, "Send Payment");
    a.put(bG.k, "Agree");
    a.put(bG.l, "%s asks that you:");
    a.put(bG.m, "<a href='%1$s'>Authorise charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
    a.put(bG.n, "Share basic account information.");
    a.put(bG.o, "Agree to the %1$s <a href='%2$s'>privacy policy</a> and <a href='%3$s'>user agreement</a>.");
    a.put(bG.p, "Consent");
    a.put(bG.q, "Email");
    a.put(bG.r, "Mock Data");
    a.put(bG.s, "Sandbox");
    a.put(bG.t, "Expires");
    a.put(bG.u, "Forgotten your password?");
    a.put(bG.v, "From");
    a.put(bG.w, "How would you like to fund future payments to %1$s?");
    a.put(bG.x, "<h1><strong>Future Payment Agreement</strong></h1><p>Your default payment method will be used to pay for future PayPal payments from this merchant.</p><p>To cancel this agreement, log in to your PayPal account, go to <strong>Profile</strong> &gt; <strong>My Settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>The Recurring Payment section of the <a href='%s'>PayPal User Agreement</a> shall apply.</p><p>To make sure payments work with your PayPal account, this app may simulate a small test transaction, but no money will be transferred for this.</p>");
    a.put(bG.y, "Internal Error");
    a.put(bG.z, "<p>By clicking the button below, I hereby agree to the terms of the <a href='%1$s'>PayPal User Agreement</a> and declare that I am in compliance with Japanese laws and regulations, including sanctions against payments to North Korea and Iran pursuant to the <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> to complete the transaction.</p>");
    a.put(bG.A, "Log In");
    a.put(bG.B, "Log In with PayPal");
    a.put(bG.C, "Log out");
    a.put(bG.D, "Log out");
    a.put(bG.E, "Okay");
    a.put(bG.F, "Password");
    a.put(bG.G, "Pay with");
    a.put(bG.H, "Pay with Card");
    a.put(bG.I, "Phone");
    a.put(bG.J, "PIN");
    a.put(bG.K, "PayPal protects your <a href='%s'>privacy</a> and financial information.");
    a.put(bG.L, "Processing");
    a.put(bG.M, "Remember card");
    a.put(bG.N, "There was a problem communicating with the PayPal servers. Please try again.");
    a.put(bG.O, "Please log in to PayPal again.");
    a.put(bG.P, "Session expired.");
    a.put(bG.Q, "Stay logged in");
    a.put(bG.R, "System error (%s). Please try again later.");
    a.put(bG.S, "Try Again");
    a.put(bG.T, "Payments from this device are not allowed.");
    a.put(bG.U, "Unauthorised Device");
    a.put(bG.V, "Payments to this merchant are not allowed (invalid clientId).");
    a.put(bG.W, "Invalid merchant");
    a.put(bG.X, "Your Order");
    a.put(bG.Y, "Clear Card?");
    a.put(bG.Z, "Consent Failed");
    a.put(bG.aa, "Connection Failed");
    a.put(bG.ab, "Login Failed");
    a.put(bG.ac, "Log in with password");
    a.put(bG.ad, "Log in with PIN");
    a.put(bG.ae, "One moment…");
    a.put(bG.af, "Payment Failed");
    a.put(bG.ag, "Scan");
    a.put(bG.ah, "Via");
    ...
    b.put("FUTURE_PAYMENT_LEGAL_DETAILS|US", "<h1><strong>Future Payment Agreement</strong></h1><p>PayPal will first use your PayPal balance to pay for purchases. If that doesn’t cover the total, your bank account, PayPal Credit, debit card, credit card and/or eCheque will be used in that order.</p><p>To cancel this agreement, go to www.paypal.com.au <strong>Profile</strong> &gt; <strong>My Settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>A small payment authorisation may be required to make sure your PayPal account can be charged in the future. The authorisation will be voided and you won’t be charged.</p>");
    ...
    b.put("FUTURE_PAYMENT_LEGAL_DETAILS|JP", "<h1><strong>Future Payment authorisation</strong></h1><p>To make sure your PayPal account can be charged in the future, this app may simulate a small test transaction but no payment will be transferred.</p><p>Your default payment method will be used to pay for PayPal purchases.</p><p>To cancel this authorisation, log in to your PayPal account, go to <strong>Profile</strong> &gt; <strong>My settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>Please see the “Authorised Payments” and “Pre-approved Payments” sections of the <a href='%s'>PayPal User Agreement</a> for more information.</p>");
    ...
    c.put("PAYEE_ACCOUNT_NO_CONFIRMED_EMAIL", "Payee account does not have a confirmed email address.");
