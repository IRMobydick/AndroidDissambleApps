...
public final class PRNGFixes
{
  ...
  public static class LinuxPRNGSecureRandom extends SecureRandomSpi
  {
    ...
    protected void engineNextBytes(byte[] paramArrayOfByte)
    {
      // Byte code:
      //   0: aload_0
      //   1: getfield 89	com/braintreegateway/encryption/PRNGFixes$LinuxPRNGSecureRandom:mSeeded	Z
      //   4: ifne +10 -> 14
      //   7: aload_0
      //   8: invokestatic 95	com/braintreegateway/encryption/PRNGFixes:access$000	()[B
      //   11: invokevirtual 98	com/braintreegateway/encryption/PRNGFixes$LinuxPRNGSecureRandom:engineSetSeed	([B)V
      //   14: getstatic 32	com/braintreegateway/encryption/PRNGFixes$LinuxPRNGSecureRandom:sLock	Ljava/lang/Object;
      //   17: astore_3
      //   18: aload_3
      //   19: monitorenter
      //   20: aload_0
      //   21: invokespecial 100	com/braintreegateway/encryption/PRNGFixes$LinuxPRNGSecureRandom:getUrandomInputStream	()Ljava/io/DataInputStream;
      //   24: astore 5
      //   26: aload_3
      //   27: monitorexit
      //   28: aload 5
      ...
      //   31: aload 5
      //   33: aload_1
      //   34: invokevirtual 103	java/io/DataInputStream:readFully	([B)V
      //   37: aload 5
      //   39: monitorexit
      //   40: return
      //   41: astore 4
      ...
      //   65: getstatic 26	com/braintreegateway/encryption/PRNGFixes$LinuxPRNGSecureRandom:URANDOM_FILE	Ljava/io/File;
    ...
    protected void engineSetSeed(byte[] paramArrayOfByte)
    {
      ...
      {
        throw new SecurityException("Failed to mix seed into " + URANDOM_FILE, localIOException);
      }
    }
  }
