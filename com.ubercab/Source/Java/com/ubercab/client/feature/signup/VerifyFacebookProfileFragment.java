...
public class VerifyFacebookProfileFragment extends RiderFragment
  implements SignupEvents, PhoneNumberCountryTextWatcher.Listener
{
  ...
  public static Fragment newInstance(SignupData paramSignupData)
  {
    ...
    localVerifyFacebookProfileFragment.setArguments(localBundle);
  ...
  private void sendValidateAccountRequest()
  {
    ...
    this.mSignupClient.validateAccount(str1, str2, str3, "thisisnotarealpassword1234567$");
  }
  ...
  {
    if ((!TextUtils.isEmpty(this.mEditTextFirstName.getText())) && (!TextUtils.isEmpty(this.mEditTextLastName.getText())) && (!TextUtils.isEmpty(this.mEditTextEmail.getText())) && (!TextUtils.isEmpty(this.mEditTextPhone.getText())));
  ...
  {
    View localView = paramLayoutInflater.inflate(2130903185, paramViewGroup, false);
  ...
  {
    super.onResume();
    this.mActionBar.setTitle(getString(2131559340));
    updateUI();
  }
  ...
  public void onValidateAccountResponseEvent(ValidateAccountResponseEvent paramValidateAccountResponseEvent)
  {
    ...
    do
    {
      ...
      {
        MessageDialogFragment.show(getRiderActivity(), 0, null, getString(2131558420));
        return;
      }
    }
