...
public class PaymentOtpFragment extends RiderFragment
{
  ...
  public static PaymentOtpFragment newInstance(String paramString)
  {
    Bundle localBundle = new Bundle();
    localBundle.putString("uuid", paramString);
    PaymentOtpFragment localPaymentOtpFragment = new PaymentOtpFragment();
    localPaymentOtpFragment.setArguments(localBundle);
  ...
  public void onPingEvent(PingEvent paramPingEvent)
  {
    ...
    if (!PingUtils.hasClient(localPing))
      return;
    String str = localPing.getClient().getEmail();
 ...
 * Qualified Name:     com.ubercab.client.feature.payment.PaymentOtpFragment
