...
import com.ubercab.ui.R.color;
import com.ubercab.ui.R.styleable;
...
public class CircleImageView extends ImageView
{
  ...
  public CircleImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i = getResources().getColor(DEFAULT_BORDER_COLOR);
    this.mBorderColor = localTypedArray.getColor(R.styleable.CircleImageView_borderColor, i);
    this.mBorderWidth = localTypedArray.getDimensionPixelSize(R.styleable.CircleImageView_borderWidth, 1);
 ...
 * Qualified Name:     com.ubercab.ui.view.CircleImageView
