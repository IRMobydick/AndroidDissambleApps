...
public class ResponseData
{
  ...
  public static ResponseData fromJson(String paramString)
  {
    try
    {
      ...
      localResponseData.error = localJSONObject.optString("error", null);
      localResponseData.trackerToken = localJSONObject.optString("tracker_token", null);
      localResponseData.trackerName = localJSONObject.optString("tracker_name", null);
      localResponseData.network = localJSONObject.optString("network", null);
      localResponseData.campaign = localJSONObject.optString("campaign", null);
      localResponseData.adgroup = localJSONObject.optString("adgroup", null);
      localResponseData.creative = localJSONObject.optString("creative", null);
      return localResponseData;
    }
    catch (JSONException localJSONException)
    {
      ...
      return fromError(String.format("Failed to parse json response: %s", arrayOfObject));
    }
  }
  ...
  public Map<String, String> toDic()
  {
    ...
    label235: for (String str2 = "true"; ; str2 = "false")
    {
