    ...
    implements Serializable
  {
    ...
    public boolean exactlySameAs(PhoneNumber paramPhoneNumber)
    {
      ...
      if (paramPhoneNumber == null)
        bool = false;
      while ((this == paramPhoneNumber) || ((this.countryCode_ == paramPhoneNumber.countryCode_) && (this.nationalNumber_ == paramPhoneNumber.nationalNumber_) && (this.extension_.equals(paramPhoneNumber.extension_)) && (this.italianLeadingZero_ == paramPhoneNumber.italianLeadingZero_) && (this.numberOfLeadingZeros_ == paramPhoneNumber.numberOfLeadingZeros_) && (this.rawInput_.equals(paramPhoneNumber.rawInput_)) && (this.countryCodeSource_ == paramPhoneNumber.countryCodeSource_) && (this.preferredDomesticCarrierCode_.equals(paramPhoneNumber.preferredDomesticCarrierCode_)) && (hasPreferredDomesticCarrierCode() == paramPhoneNumber.hasPreferredDomesticCarrierCode())))
        return bool;
      return false;
    }
    ...
    public int hashCode()
    {
      ...
      {
        k = i;
        m = 53 * (53 * (53 * (53 * (53 * (j + k) + getNumberOfLeadingZeros()) + getRawInput().hashCode()) + getCountryCodeSource().hashCode()) + getPreferredDomesticCarrierCode().hashCode());
    ...
    public PhoneNumber mergeFrom(PhoneNumber paramPhoneNumber)
    {
      ...
      if (paramPhoneNumber.hasNumberOfLeadingZeros())
        setNumberOfLeadingZeros(paramPhoneNumber.getNumberOfLeadingZeros());
    ...
    public PhoneNumber setNumberOfLeadingZeros(int paramInt)
    {
      this.hasNumberOfLeadingZeros = true;
      this.numberOfLeadingZeros_ = paramInt;
      return this;
    }
    ...
    public String toString()
    {
      ...
      if (hasNumberOfLeadingZeros())
        localStringBuilder.append(" Number of leading zeros: ").append(this.numberOfLeadingZeros_);
      if (hasExtension())
