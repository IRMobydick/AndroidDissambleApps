...
public abstract interface People
{
  ...
  public abstract PendingResult<LoadPeopleResult> load(GoogleApiClient paramGoogleApiClient, String[] paramArrayOfString);
  ...
  public static abstract interface LoadPeopleResult extends Releasable, Result
  {
