...
public class Tracker
{
  ...
  void a(ai paramai)
  {
    ...
    if (this.Bt.eZ())
    {
      String str2 = this.Bt.fa();
      set("&tid", str2);
      z.V("[Tracker] trackingId loaded: " + str2);
    }
    if (this.Bt.fb())
    {
      String str1 = Double.toString(this.Bt.fc());
      set("&sf", str1);
  ...
  public void send(Map<String, String> paramMap)
  {
    ...
    if ((!str2.equals("transaction")) && (!str2.equals("item")) && (!this.Bn.eJ()))
    {
    ...
    implements GoogleAnalytics.a
  {
    ...
    public void i(Activity paramActivity)
    {
      ...
      label125: for (String str = Tracker.c(Tracker.this).k(paramActivity); ; str = paramActivity.getClass().getCanonicalName())
      {
