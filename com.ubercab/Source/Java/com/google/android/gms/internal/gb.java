  ...
  implements cf.b
{
  ...
  public Bundle b(Context paramContext, gd paramgd, String paramString)
  {
    ...
    synchronized (this.mw)
    {
      ...
      Iterator localIterator1 = this.vP.keySet().iterator();
      if (localIterator1.hasNext())
      {
        String str = (String)localIterator1.next();
        localBundle2.putBundle(str, ((ge)this.vP.get(str)).toBundle());
      }
    }
    localBundle1.putBundle("slots", localBundle2);
    ArrayList localArrayList = new ArrayList();
    Iterator localIterator2 = this.vO.iterator();
    while (localIterator2.hasNext())
      localArrayList.add(((ga)localIterator2.next()).toBundle());
