  ...
  implements SensorsApi
{
  ...
  {
    return paramGoogleApiClient.b(new a()
    {
      protected void a(kk paramAnonymouskk)
        throws RemoteException
      {
  ...
  public PendingResult<Status> remove(GoogleApiClient paramGoogleApiClient, final OnDataPointListener paramOnDataPointListener)
  {
    ...
    return a(paramGoogleApiClient, new q(locall, null), new b()
    {
      public void jd()
      {
  ...
  private static abstract class a<R extends Result> extends BaseImplementation.a<R, kk>
  {
    public a()
    {
      super();
