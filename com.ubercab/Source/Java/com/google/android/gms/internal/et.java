...
public abstract interface et extends IInterface
{
    ...
    implements et
  {
      ...
      implements et
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          localParcel1.writeInterfaceToken("com.google.android.gms.ads.internal.rawhtmlad.client.IRawHtmlPublisherAdViewListener");
          if (parames != null);
