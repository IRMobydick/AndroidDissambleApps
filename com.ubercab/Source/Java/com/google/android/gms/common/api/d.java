  ...
  implements DialogInterface.OnCancelListener, LoaderManager.LoaderCallbacks<ConnectionResult>
{
  ...
  public static d a(FragmentActivity paramFragmentActivity)
  {
    ...
    try
    {
      ...
      {
        locald = new d();
        localFragmentManager.beginTransaction().add(locald, "GmsSupportLifecycleFragment").commit();
  ...
  private void b(int paramInt, ConnectionResult paramConnectionResult)
  {
    ...
    b localb = (b)this.JF.get(paramInt);
    if (localb != null)
    {
      al(paramInt);
  ...
  public void onAttach(Activity paramActivity)
  {
    ...
    if (i < this.JF.size())
    {
      int j = this.JF.keyAt(i);
      a locala = am(j);
      if ((locala != null) && (((b)this.JF.valueAt(i)).JG != locala.JG))
  ...
  static class a extends Loader<ConnectionResult>
    ...
    implements Runnable
  {
    ...
    public c(int paramConnectionResult, ConnectionResult arg3)
    {
      this.JK = paramConnectionResult;
      Object localObject;
      this.JL = localObject;
    }
    ...
    public void run()
    {
      if (this.JL.hasResolution())
        try
        {
          int i = 1 + (1 + d.this.getActivity().getSupportFragmentManager().getFragments().indexOf(d.this) << 16);
          this.JL.startResolutionForResult(d.this.getActivity(), i);
          return;
        }
