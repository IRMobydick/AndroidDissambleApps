...
public class RequestCreator
{
    ...
    throws IOException
  {
    ...
    Request localRequest = createRequest(l);
    String str = Utils.createKey(localRequest, new StringBuilder());
    GetAction localGetAction = new GetAction(this.picasso, localRequest, this.skipMemoryCache, str);
    return BitmapHunter.forRequest(this.picasso.context, this.picasso, this.picasso.dispatcher, this.picasso.cache, this.picasso.stats, localGetAction, this.picasso.dispatcher.downloader).hunt();
  }
