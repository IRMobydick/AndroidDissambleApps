...
public class HttpURLConnectionImpl extends HttpURLConnection
{
    ...
    throws IOException
  {
    ...
    do
      try
      {
        ...
        {
          boolean bool1 = this.doOutput;
          RetryableSink localRetryableSink = null;
          if (bool1)
          {
            boolean bool2 = this.fixedContentLength < 0L;
            localRetryableSink = null;
            if (!bool2)
              localRetryableSink = Util.emptySink();
          }
          this.httpEngine = newHttpEngine(this.method, null, localRetryableSink, null);
          return;
        }
      }
      catch (IOException localIOException)
  ...
  private HttpEngine newHttpEngine(String paramString, Connection paramConnection, RetryableSink paramRetryableSink, Response paramResponse)
  {
    ...
    boolean bool1 = HttpMethod.hasRequestBody(paramString);
    boolean bool2 = false;
    if (bool1)
    {
    ...
    while (true)
    {
      ...
      return new HttpEngine(localOkHttpClient, localRequest, bool2, paramConnection, null, paramRetryableSink, paramResponse);
      label220: if (this.chunkLength > 0)
      {
