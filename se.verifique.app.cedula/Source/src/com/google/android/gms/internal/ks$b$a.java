  ...
  implements SafeParcelable, d
{
  ...
  static
  {
    b.put("leftImageOffset", hy.a.a("leftImageOffset", 2));
    b.put("topImageOffset", hy.a.a("topImageOffset", 3));
  }
  ...
  ks$b$a(Set paramSet, int paramInt1, int paramInt2, int paramInt3)
  {
    this.c = paramSet;
    this.d = paramInt1;
    this.e = paramInt2;
