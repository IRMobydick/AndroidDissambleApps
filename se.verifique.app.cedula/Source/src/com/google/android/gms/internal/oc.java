...
public abstract class oc extends Binder
  implements ob
{
  public static ob a(IBinder paramIBinder)
  {
    Object localObject;
    ...
    while (true)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof ob)))
      {
        localObject = (ob)localIInterface;
        continue;
      }
      localObject = new od(paramIBinder);
    }
  }
