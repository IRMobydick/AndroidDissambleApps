...
public final class AnimatorSet extends Animator
{
  ...
  public final void playSequentially(List paramList)
  {
  ...
  public final void playSequentially(Animator[] paramArrayOfAnimator)
  {
    ...
    while (true)
    {
      return;
      label26: 
      while (i < -1 + paramArrayOfAnimator.length)
      {
  ...
  public final void playTogether(Collection paramCollection)
  {
 ...
 * Qualified Name:     net.photopay.nineoldandroids.animation.AnimatorSet
