...
class FloatKeyframeSet extends KeyframeSet
{
  ...
  public float getFloatValue(float paramFloat)
  {
    ...
    while (true)
    {
      ...
      label615: f1 = ((Number)((Keyframe)this.mKeyframes.get(-1 + this.mNumKeyframes)).getValue()).floatValue();
    }
  }
 ...
 * Qualified Name:     net.photopay.nineoldandroids.animation.FloatKeyframeSet
