...
public final class ObjectAnimator extends ValueAnimator
{
  ...
  public static ObjectAnimator ofFloat(Object paramObject, Property paramProperty, float[] paramArrayOfFloat)
  {
    ObjectAnimator localObjectAnimator = new ObjectAnimator(paramObject, paramProperty);
    localObjectAnimator.setFloatValues(paramArrayOfFloat);
    return localObjectAnimator;
  }
  ...
  public static ObjectAnimator ofInt(Object paramObject, Property paramProperty, int[] paramArrayOfInt)
  {
    ObjectAnimator localObjectAnimator = new ObjectAnimator(paramObject, paramProperty);
    localObjectAnimator.setIntValues(paramArrayOfInt);
    return localObjectAnimator;
  ...
  public static ObjectAnimator ofObject(Object paramObject, Property paramProperty, TypeEvaluator paramTypeEvaluator, Object[] paramArrayOfObject)
  {
    ObjectAnimator localObjectAnimator = new ObjectAnimator(paramObject, paramProperty);
    localObjectAnimator.setObjectValues(paramArrayOfObject);
    localObjectAnimator.setEvaluator(paramTypeEvaluator);
  ...
  public final void setObjectValues(Object[] paramArrayOfObject)
  {
    if ((this.mValues == null) || (this.mValues.length == 0))
      ...
      {
        PropertyValuesHolder[] arrayOfPropertyValuesHolder2 = new PropertyValuesHolder[1];
        arrayOfPropertyValuesHolder2[0] = PropertyValuesHolder.ofObject(this.mProperty, null, paramArrayOfObject);
        setValues(arrayOfPropertyValuesHolder2);
      }
    while (true)
    {
      return;
      PropertyValuesHolder[] arrayOfPropertyValuesHolder1 = new PropertyValuesHolder[1];
      arrayOfPropertyValuesHolder1[0] = PropertyValuesHolder.ofObject(this.mPropertyName, null, paramArrayOfObject);
      setValues(arrayOfPropertyValuesHolder1);
      continue;
 ...
 * Qualified Name:     net.photopay.nineoldandroids.animation.ObjectAnimator
