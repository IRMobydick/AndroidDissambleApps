...
public class DraftViewPager extends ViewGroup
{
  ...
  static
  {
    ...
    {
      public int compare(DraftViewPager.ItemInfo paramItemInfo1, DraftViewPager.ItemInfo paramItemInfo2)
      {
  ...
  public DraftViewPager(Context paramContext)
  {
    this(paramContext, null);
  }

  public DraftViewPager(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    Resources localResources = paramContext.getResources();
    this.mPreviewRatio = (localResources.getInteger(2131492867) / 100.0F);
    this.mDraftMargin = localResources.getDimensionPixelOffset(2131427384);
    initViewPager();
  }
  ...
  private int getAdjustedXDestination(int paramInt)
  {
    return paramInt * ((int)(getWidth() * this.mPreviewRatio) + 2 * this.mDraftMargin);
  }
  ...
  public void addFocusables(@NonNull ArrayList<View> paramArrayList, int paramInt1, int paramInt2)
  {
  ...
  public void addTouchables(@NonNull ArrayList<View> paramArrayList)
  {
    for (int i = 0; i < getChildCount(); i++)
    {
  ...
  {
    int i = getWidth();
    return (int)(i - i * this.mPreviewRatio) / 2;
  }
    ...
    if (i5 < i)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if (!localLayoutParams.isDecor)
          break label379;
        int i12 = 0x7 & localLayoutParams.gravity;
        int i13 = 0x70 & localLayoutParams.gravity;
        switch (i12)
        {
        case 2:
        case 4:
        default:
          ...
          default:
            i15 = i1;
            label212: int i16 = i14 + m;
            i4++;
            localView.layout(i16, i15, i16 + localView.getMeasuredWidth(), i15 + localView.getMeasuredHeight());
          case 48:
          case 16:
          case 80:
          }
      ...
      while (true)
      {
        ...
        break label172;
        i14 = Math.max((j - localView.getMeasuredWidth()) / 2, n);
        break label172;
        i14 = j - i2 - localView.getMeasuredWidth();
        i2 += localView.getMeasuredWidth();
        break label172;
        i15 = i1;
        i1 += localView.getMeasuredHeight();
        break label212;
        i15 = Math.max((k - localView.getMeasuredHeight()) / 2, i1);
        break label212;
        i15 = k - i3 - localView.getMeasuredHeight();
        i3 += localView.getMeasuredHeight();
        break label212;
        label379: ItemInfo localItemInfo = infoForChild(localView);
        if (localItemInfo == null)
          continue;
        int i6 = n + (j + this.mPageMargin) * localItemInfo.position;
        int i7 = i1;
        int i8 = (int)(getWidth() * (1.0F - this.mPreviewRatio));
        int i9 = (int)(getWidth() * ((1.0F - this.mPreviewRatio) / 2.0F));
        if (localItemInfo.position > 0)
        {
          int i10 = i8 * localItemInfo.position;
          int i11 = 2 * this.mDraftMargin * localItemInfo.position;
          localView.layout(i11 + (i9 + (i6 - i10)), i7, i11 + (i9 + (i6 + localView.getMeasuredWidth() - i10)), i7 + localView.getMeasuredHeight());
          continue;
        }
        localView.layout(i6 + i9, i7, i9 + (i6 + localView.getMeasuredWidth()), i7 + localView.getMeasuredHeight());
      }
    }
  ...
  public boolean onTouchEvent(@NonNull MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      int i2 = (int)(getWidth() * this.mPreviewRatio);
      ...
      int i1 = getScrollX();
      setCurrentItemInternal(determineTargetPage(i1 / (int)(n * this.mPreviewRatio), i1 % n / n, m, (int)(MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, this.mActivePointerId)) - this.mInitialMotionX)), true, true, m);
      this.mActivePointerId = -1;
      endDrag();
  ...
  public void populate()
  {
    ...
    while (true)
    {
      ...
      {
        DraftPagerAdapter localDraftPagerAdapter = this.mAdapter;
        int i3 = this.mCurItem;
        if (localItemInfo1 == null)
          break label523;
        localObject = localItemInfo1.object;
        localDraftPagerAdapter.setPrimaryItem(this, i3, localObject);
        this.mAdapter.finishUpdate(this);
        if (!hasFocus())
          break;
  ...
  public void setAdapter(DraftFragmentStatePagerAdapter paramDraftFragmentStatePagerAdapter)
  {
    if (this.mAdapter != null)
    {
    ...
    DraftPagerAdapter localDraftPagerAdapter = this.mAdapter;
    this.mAdapter = paramDraftFragmentStatePagerAdapter;
    if (this.mAdapter != null)
    {
    ...
    while (true)
    {
      if ((this.mAdapterChangeListener != null) && (localDraftPagerAdapter != paramDraftFragmentStatePagerAdapter))
        this.mAdapterChangeListener.onAdapterChanged(localDraftPagerAdapter, paramDraftFragmentStatePagerAdapter);
      return;
      label231: populate();
    }
  }
  ...
  void setCurrentItemInternal(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        populate();
        k = getAdjustedXDestination(paramInt1);
        if (!paramBoolean1)
          break label244;
        smoothScrollTo(paramInt1, k, 0, paramInt2);
  ...
  public static class LayoutParams extends ViewGroup.LayoutParams
  {
    ...
    public LayoutParams(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, DraftViewPager.LAYOUT_ATTRS);
  ...
  {
    public abstract void onAdapterChanged(DraftPagerAdapter paramDraftPagerAdapter1, DraftPagerAdapter paramDraftPagerAdapter2);
  }
  ...
  private class PagerObserver extends DataSetObserver
  {
    ...
    {
      DraftViewPager.this.dataSetChanged();
    }
  ...
  {
    public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new DraftViewPager.SavedState.1());
 ...
 * Qualified Name:     android.support.v4.view.DraftViewPager
